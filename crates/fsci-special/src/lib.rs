...
pub use beta::{
    ...
    btdtr, btdtri, fdtr, fdtri, nbdtr, nbdtrc, nbdtri, stdtr, stdtri,
};
pub use convenience::{
...
pub use elliptic::{
    ELLIPTIC_DISPATCH_PLAN, ellipe, ellipeinc, ellipj, ellipk, ellipkinc, exp1, expi, expn_scalar,
    lambertw,
};
pub use error::{
...
pub use gamma::{
    ...
    gammainc, gammainc_scalar, gammaincc, gammaincc_scalar, gammaln, gammaln_scalar, gdtr, gdtri,
    pdtr, pdtrc, pdtri, perm, polygamma, rgamma, zeta, zetac,
};
