...
pub use quad::{
    ...
    cumulative_trapezoid_initial, gauss_kronrod_quad, gauss_legendre, newton_cotes,
    ...
    tplquad, trapezoid, trapezoid_irregular, trapezoid_richardson, trapezoid_uniform,
};
pub use rk::{
