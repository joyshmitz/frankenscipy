...
pub use quad::{
    ...
    cumulative_trapezoid, cumulative_trapezoid_axis_2d, cumulative_trapezoid_initial,
    cumulative_trapezoid_uniform, dblquad, simpson_axis_2d, trapezoid_axis_2d,
    dblquad_many, dblquad_rect, fixed_quad, gauss_kronrod_quad, gauss_legendre, line_integral,
    tplquad_many,
    monte_carlo_integrate, newton_cotes, newton_cotes_quad, nquad, nquad_many, nsum, qmc_quad, quad,
    quad_many,
