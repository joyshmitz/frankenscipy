...
pub use quad::{
    ...
    gauss_kronrod_quad, newton_cotes, newton_cotes_quad, nquad, quad, quad_vec, romb, romb_func,
    romberg, simpson, simpson_irregular, simpson_uniform, tplquad, trapezoid, trapezoid_irregular,
    trapezoid_uniform,
};
pub use rk::{
